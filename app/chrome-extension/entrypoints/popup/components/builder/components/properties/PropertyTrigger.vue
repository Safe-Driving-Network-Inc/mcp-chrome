<template>
  ...
  <div class="form-section">
    <div class="section-header"><span class="section-title">Trigger Method</span></div>
    <div class="form-group checkbox-group">
      <label class="checkbox-label"
  ...
  <div v-if="cfg.modes.url" class="form-section">
    <div class="section-title">Visit URL Match</div>
  ...
  <div v-if="cfg.modes.command" class="form-section">
    ...
    <div class="form-group">
      <label class="form-label"
        >Command Key (must be declared in manifest commands beforehand)</label
      >
      <input
        class="form-input"
    ...
    <div class="text-xs text-slate-500" style="padding: 0 20px"
      >Note: Chrome extension shortcuts must be statically declared in the manifest; they cannot be
  ...
  <div class="form-section">
    <div class="text-xs text-slate-500" style="padding: 0 20px"
      >Note: Triggers are synced to the background trigger table (URL / context menu / shortcut /
      DOM) and scheduled tasks (interval / daily / once) when the workflow is saved.
    </div>
  </div>
</template>
