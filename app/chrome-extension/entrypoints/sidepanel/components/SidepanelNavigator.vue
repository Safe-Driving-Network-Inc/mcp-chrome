<template>
  ...
  >
    <!-- Trigger button (also serves as the drag handle) -->
    <button
      ref="triggerRef"
          ...
          <div class="navigator-items">
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">AI Assistant</span>
                <span class="navigator-item-desc">Agent chat and tasks</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">Workflows</span>
                <span class="navigator-item-desc">Record and replay automations</span>
              </div>
            ...
            >
              ...
              <div class="navigator-item-content">
                <span class="navigator-item-title">Element Markers</span>
