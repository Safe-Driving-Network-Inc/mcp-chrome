 ...
 * @description Implements atomic seq allocation and event storage
 */
...
/**
 * Create the EventsStore implementation
 * @description
 * - append() allocates seq atomically inside a single transaction
 * - RunRecordV3.nextSeq is the single source of truth for seq
 */
export function createEventsStore(): EventsStore {
  return {
    ...
    /**
     * List events
     * @description Uses the composite primary key [runId, seq] for efficient range queries
     */
