 ...
 * @description Registration and lookup for node and trigger plugins
 */
...
/**
 * Plugin registry
 * @description A singleton holding every registered node and trigger
 */
export class PluginRegistry implements PluginRegistrationContext {
   ...
   * @description Overwrites any node already registered under the same name
   */
   ...
   * @description Overwrites any trigger already registered under the same name
   */
  ...
  /**
   * Get every registered node type
   */
  ...
  /**
   * Get every registered trigger type
   */
