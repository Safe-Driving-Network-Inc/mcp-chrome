 ...
 * @description The protocol types for communicating over chrome.runtime.Port
 */
...
export interface RpcSubscribeAck {
  ...
  /** The subscribed Run ID (optional; null means subscribe to everything) */
  runId: RunId | null;
}

/**
 * Every RPC message type
 */
...
/**
 * Whether a message is an RPC request
 */
...
/**
 * Whether a message is an RPC response
 */
...
/**
 * Whether a message is an RPC event
 */
