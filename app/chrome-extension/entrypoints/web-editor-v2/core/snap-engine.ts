 ...
 *
 * Note: uses a bidirectional scan that expands outward from the target position,
 * so nearby elements are still found when the target sits late in the children list.
 */
 ...
 *
 * Note:
 * - When a snap occurs, show the spacing along the *other* axis
 * - lockX is a vertical alignment line, so show the Y-axis spacing
 * - lockY is a horizontal alignment line, so show the X-axis spacing
 */
