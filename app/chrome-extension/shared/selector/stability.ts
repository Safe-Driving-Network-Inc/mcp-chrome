/**
 * Selector Stability - selector stability scoring
 */
...
/**
 * Compute a selector's stability score
 */
...
/**
 * Attach stability scores to selector candidates
 */
...
/**
 * Compare the priority of two selector candidates
 * A negative result means a wins; a positive result means b wins
 */
export function compareSelectorCandidates(a: SelectorCandidate, b: SelectorCandidate): number {
  // 1. A user-specified weight wins
  const aw = a.weight ?? 0;
  const bw = b.weight ?? 0;
