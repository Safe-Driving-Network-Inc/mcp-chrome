...
export function registerBuiltinSpecs() {
    ...
    schema: [
      {
        ...
        help: 'Target address, supports the {var} variable template',
        default: '',
      },
    ],
    defaults: { url: '' },
    ...
    schema: [
      {
        ...
        help: 'Pick or type an element selector',
      },
      {
        key: 'before',
        label: 'Before',
  ...
  registerNodeSpec({
    ...
    schema: [
      { key: 'target', label: 'Target', type: 'json', widget: 'targetlocator' },
      {
        ...
        type: 'string',
        required: true,
        help: 'Supports the {var} template',
      },
    ],
    defaults: { value: '' },
  });
  ...
  registerNodeSpec({
    ...
    version: 1,
    display: { label: 'Dispatch event', iconClass: 'icon-trigger', category: 'Tools' },
    ports: { inputs: 1, outputs: [{ label: 'default' }] },
    schema: [
      { key: 'target', label: 'Target', type: 'json', widget: 'targetlocator' },
  ...
  registerNodeSpec({
    ...
    version: 1,
    display: { label: 'Run subflow', iconClass: 'icon-exec', category: 'Flow' },
    ports: { inputs: 1, outputs: [{ label: 'default' }] },
    schema: [
      { key: 'flowId', label: 'Flow ID', type: 'string', required: true },
      { key: 'inline', label: 'Run inline', type: 'boolean', default: false },
  ...
  registerNodeSpec({
    ...
    schema: [
      ...
      { key: 'subflowId', label: 'Subflow ID', type: 'string', required: true },
      {
        ...
        type: 'number',
        default: 1,
        help: 'Run subflows concurrently (variables are shallow-copied and not merged back)',
      },
    ],
  ...
  registerNodeSpec({
    ...
    version: 1,
    display: { label: 'While', iconClass: 'icon-while', category: 'Logic' },
    ports: { inputs: 1, outputs: [{ label: 'default' }] },
    schema: [
    ...
    schema: [
      ...
      { key: 'description', label: 'Description', type: 'string' },
      {
        ...
        fields: [
          ...
          { key: 'command', label: 'Keyboard shortcut', type: 'boolean', default: false },
